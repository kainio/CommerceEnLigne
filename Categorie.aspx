<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Categorie.aspx.cs" Inherits="CommerceEnligne.Categorie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
        SelectCommand="SELECT [Nom], [Prix], [Photo] FROM [Produit] WHERE ([IDCatégorie] = @IDCatégorie)">
        <SelectParameters>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="NomCategorie" SortExpression="NomCategorie">
                ...
                <ItemTemplate>
                    <asp:HyperLink ID="NCategorie" runat="server" NavigateUrl='<%# Eval("IDCategorie", "~/categorie.aspx?id={0}") %>'><asp:Label ID="Label2" runat="server" Text='<%# Bind("NomCategorie") %>'></asp:Label></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
